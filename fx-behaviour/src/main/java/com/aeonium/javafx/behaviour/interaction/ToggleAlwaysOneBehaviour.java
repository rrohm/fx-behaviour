...
public class ToggleAlwaysOneBehaviour extends FXAbstractBehaviour {
  ...
  public ToggleAlwaysOneBehaviour() {
    ...
    this.onMouseClicked = ToggleAlwaysOneBehaviour::handle;
    this.onMousePressed = ToggleAlwaysOneBehaviour::handle;
    this.onMouseReleased = ToggleAlwaysOneBehaviour::handle;
