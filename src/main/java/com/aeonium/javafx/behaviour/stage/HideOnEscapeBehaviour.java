...
/**
 * Make a node listen on ESCAPE key hits, and hides the stage if ESCAPE has been
 * pressed (... if it was the primary stage, the application terminates).
 *
 * @author Robert Rohm&lt;r.rohm@aeonium-systems.de&gt;
 */
public class HideOnEscapeBehaviour extends FXAbstractBehaviour {

  private static final Logger LOG = Logger.getLogger(HideOnEscapeBehaviour.class.getName());
